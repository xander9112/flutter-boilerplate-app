...
import 'package:flutter_boilerplate_app/config/themes/text_styles.dart';
...
ThemeData themeDark = ThemeData(
  ...
  scaffoldBackgroundColor: ThemeConfig.dark,
  backgroundColor: ThemeConfig.dark,
  textTheme: TextTheme(
    subtitle1: TextStyles.formTextNormal.copyWith(
